...
def main():
    ...
    if len(sys.argv) == 1:
        ...
        print("  reflect <id> - Manually trigger reflection for agent")
        print("  plan <id>    - Show agent's daily plan")
        ...
        print("  python main.py agent isabella --reflections")
        print("  python main.py reflect isabella")
        print("  python main.py plan isabella")
        print("  python main.py plan isabella --generate")
